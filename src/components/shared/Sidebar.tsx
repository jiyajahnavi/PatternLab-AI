...
import { MessageSquare, BarChart2, User, Settings, Play, Bell } from 'lucide-react';
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `relative group p-2 rounded-lg transition-colors ${
              isActive ? 'bg-background text-accent' : 'text-muted hover:text-primary hover:bg-background'
            }`
          }
        >
          <item.icon size={20} />
